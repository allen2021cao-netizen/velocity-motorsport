...
await page.goto(process.env.TEST_URL||'http://127.0.0.1:5173/');await page.waitForFunction(()=>window.__velocity,null,{timeout:90000});await page.click('#navSetup');await page.selectOption('#quality','balanced');await page.click('#navCar');await page.click('#vehicleBtn');
for(let i=0;i<13;i++){
