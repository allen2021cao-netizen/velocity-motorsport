...
## Porsche 911 revision (v5)
Replaced the two v4 Porsche AI layers in active playback with original procedural boxer-six sound designs. The old high layer had stronger low-frequency peaks than the mid layer despite its higher requested RPM. The replacements share the same engine-order profile (three combustion events per crank revolution), with 175 Hz / 310 Hz firing references at 3500 / 6200 RPM, steady six-second periodic loops, softer upper harmonics and lower RMS. Reduced the extra synthesized tone and extended the transition from 4000 to 5900 RPM. These are designed approximations, not authentic recordings; listening approval remains with the player. No ElevenLabs credits used. Reproduce: tools/prepare-porsche-audio.mjs; measurements: tools/porsche-audio-audit.json. Other cars retain their existing banks.
