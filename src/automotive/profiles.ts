...
export const SHAPES:Record<string,CarShape>={
 ...
 r34:{...base,length:4.6,width:1.785,height:1.36,wheelbase:2.665,front:1.36,rear:-1.305,screen:.83,roofFront:.24,roofRear:-.7,backlight:-1.28,waist:.83,nose:.68,tail:.86,bulge:.07,spokes:6,wing:1.22,round:false},
 ...
 diablo:{...base,length:4.47,width:2.04,height:1.1,wheelbase:2.65,front:1.35,rear:-1.3,screen:.83,roofFront:.16,roofRear:-.5,backlight:-.99,nose:.34,tail:.7,bulge:.1,wing:1.0,round:false},
 supra:{...base,length:4.52,width:1.81,height:1.275,wheelbase:2.55,front:1.35,rear:-1.2,screen:.48,roofFront:-.12,roofRear:-.73,backlight:-1.38,nose:.54,tail:.76,bulge:.16,wing:1.22},
 viper:{...base,length:4.49,width:1.92,height:1.19,wheelbase:2.44,front:1.34,rear:-1.1,screen:.25,roofFront:-.28,roofRear:-.8,backlight:-1.28,nose:.48,tail:.73,bulge:.2,spokes:5},
 clk:{...base,length:4.85,width:1.95,height:1.1,wheelbase:2.67,front:1.38,rear:-1.29,screen:.9,roofFront:.18,roofRear:-.45,backlight:-.98,nose:.36,tail:.7,bulge:.14,spokes:10,wing:1.06},
 ...
 c5:{...base,length:4.56,width:1.87,height:1.21,wheelbase:2.654,front:1.37,rear:-1.284,screen:.48,roofFront:-.12,roofRear:-.7,backlight:-1.4,nose:.43,tail:.76,bulge:.17},
};
